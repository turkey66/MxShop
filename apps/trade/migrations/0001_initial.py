    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_no', models.CharField(blank=True, max_length=60, null=True, unique=True, verbose_name='交易支付号')),
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('nopay', '待支付')], max_length=10, verbose_name='订单状态')),
