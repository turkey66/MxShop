...
class OrderInfo(models.Model):
    ...
    trade_no = models.CharField(max_length=60, unique=True, null=True, blank=True, verbose_name="交易支付号")
    ...
    def __str__(self):
        return "%s(%s)".format(self.user.name, self.order_sn)
...
class OrderGoods(models.Model):
    ...
    def __str__(self):
        return "%s(%s)".format(self.order.order_sn, self.goods.name)